    ...
    internal class Program
    {
        static void Main(string[] args)
        {
           ...
           // p1.Input();
            ...
            //Console.WriteLine("Phan so thu 1:" + p1.ToString());
            ...
            Console.WriteLine($"{p3.ToString()} + {p4.ToString()} = {psum.ToString()} = {psum.Decimal()}");
            Console.WriteLine($"{p3.ToString()} - {p4.ToString()} = {psub.ToString()} = {psub.Decimal()}");
            Console.WriteLine($"{p3.ToString()} * {p4.ToString()} = {pmul.ToString()} = {pmul.Decimal()}");
            Console.WriteLine($"{p3.ToString()} : {p4.ToString()} = {pdiv.ToString()} = {pdiv.Decimal()}");
